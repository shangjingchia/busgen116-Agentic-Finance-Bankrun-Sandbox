...
def make_cautious_retiree(
    *,
    ...
    return Persona(
        ...
        institution_trust_prior=0.65,
        deliberation_seconds=25.0,
        information_access=[
            SOURCE_SOCIAL_MEDIA,
            SOURCE_FINANCIAL_NEWS,
            SOURCE_OFFICIAL_BANK,
...
def make_aggressive_trader(
    *,
    ...
    return Persona(
        ...
        institution_trust_prior=0.25,
        deliberation_seconds=4.0,
        information_access=[
            SOURCE_SOCIAL_MEDIA,
            SOURCE_FINANCIAL_NEWS,
            SOURCE_INTERNAL_ANALYSIS,
...
def make_gig_worker(
    *,
    ...
    return Persona(
        ...
        institution_trust_prior=0.50,
        deliberation_seconds=8.0,
        information_access=[
            SOURCE_SOCIAL_MEDIA,
            SOURCE_PEER_NETWORK,
        ],
...
def make_institutional_treasurer(
    *,
    ...
    return Persona(
        ...
        institution_trust_prior=0.75,
        deliberation_seconds=55.0,
        information_access=[
            SOURCE_FINANCIAL_NEWS,
            SOURCE_OFFICIAL_BANK,
            SOURCE_REGULATOR,
